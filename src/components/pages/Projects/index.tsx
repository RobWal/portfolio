...
const Projects = () => {
    ...
    return (
        <div className="projects">
            ...
            projectTechnicals={`Technologies used - HTML, CSS, React, TypeScript, Node.js, Heroku.`} 
            ...
            projectLiveLink={`https://deep-see-adventure.herokuapp.com/`} projectId={`deep`} />
            ...
            projectLiveLink={`https://RobWal.github.io`} projectId={`stardew`} />
            ...
            projectLiveLink={`https://okay-bloomer.herokuapp.com/`} projectId={`okay`} />
            ...
            projectLiveLink={`https://robwal.github.io/TicTacToe/`} projectId={`tic`} /> 
        </div>
    )
}
