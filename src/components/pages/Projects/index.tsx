...
const Projects = () => {
    return (
        <div className="projects">
            ...
            projectImage={`/images/featuredDeepSeaAdventure.png`} projectGithubLink={`https://github.com/RobWal/deep-sea-adventure`} 
            ...
            projectImage={`/images/featuredStardewValleyTools.png`} projectGithubLink={`https://github.com/RobWal/stardew-valley-tools`} 
            ...
            projectImage={`/images/featuredOkayBloomer.png`} projectGithubLink={`https://github.com/RobWal/okay-bloomer`} 
            ...
            projectImage={`/images/featuredJaunt.png`} projectGithubLink={`https://github.com/RobWal/jaunt`} 
            ...
            projectImage={`/images/featuredTicTacToe.png`} projectGithubLink={`https://github.com/RobWal/tic-tac-toe`} 
