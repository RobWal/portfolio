...
const Featured = () => {
    return (
        <div className='featured'>
            ...
            projectDescription={'Deep Sea Adventure is an application designed to recreate the board game by the same name. For more information - '} altProjectImageName="Deep Sea Adventure"></FeaturedProjectContainer>
